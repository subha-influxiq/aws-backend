(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/cdk/collections'), require('rxjs/operators'), require('@angular/common/http'), require('ngx-uploader'), require('@angular/forms'), require('@angular/router'), require('@angular/platform-browser'), require('moment'), require('@angular/cdk/a11y'), require('@angular/cdk/drag-drop'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@angular/cdk/stepper'), require('@angular/cdk/table'), require('@angular/cdk/tree'), require('@angular/platform-browser/animations'), require('@angular/common'), require('ngx-moment')) :
  typeof define === 'function' && define.amd ? define('listing-angular7', ['exports', '@angular/core', '@angular/material', '@angular/cdk/collections', 'rxjs/operators', '@angular/common/http', 'ngx-uploader', '@angular/forms', '@angular/router', '@angular/platform-browser', 'moment', '@angular/cdk/a11y', '@angular/cdk/drag-drop', '@angular/cdk/portal', '@angular/cdk/scrolling', '@angular/cdk/stepper', '@angular/cdk/table', '@angular/cdk/tree', '@angular/platform-browser/animations', '@angular/common', 'ngx-moment'], factory) :
  (global = global || self, factory(global['listing-angular7'] = {}, global.ng.core, global.ng.material, global.ng.cdk.collections, global.rxjs.operators, global.ng.common.http, global.ngxUploader, global.ng.forms, global.ng.router, global.ng.platformBrowser, global.momentImported, global.ng.cdk.a11y, global.ng.cdk['drag-drop'], global.ng.cdk.portal, global.ng.cdk.scrolling, global.ng.cdk.stepper, global.ng.cdk.table, global.ng.cdk.tree, global.ng.platformBrowser.animations, global.ng.common, global.ngxMoment));
}(this, function (exports, core, material, collections, operators, http, ngxUploader, forms, router, platformBrowser, momentImported, a11y, dragDrop, portal, scrolling, stepper, table, tree, animations, common, ngxMoment) { 'use strict';
  ...
  var ListingService = /** @class */ (function () {
      ...
      /** @nocollapse */ ListingService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function ListingService_Factory() { return new ListingService(); }, token: ListingService, providedIn: "root" });
  ...
  var ApiService = /** @class */ (function () {
      ...
      ApiService.propDecorators = {
          uploaderInput: [{ type: core.ViewChild, args: ['fileInput1', { static: false },] }]
      };
      return ApiService;
  }());
  if (false) {
  ...
  var ListingComponent = /** @class */ (function () {
      ...
      */
      ...
      ListingComponent.propDecorators = {
          search_settings: [{ type: core.Input }],
          click_to_add_ananother_page: [{ type: core.Input }],
          grab_link: [{ type: core.Input }],
          custombutton: [{ type: core.Input }],
          date_search_source: [{ type: core.Input }],
          date_search_endpoint: [{ type: core.Input }],
          url: [{ type: core.Input }],
          searchendpoint: [{ type: core.Input }],
          pdf_link: [{ type: core.Input }],
          searchList: [{ type: core.Input }],
          datasource: [{ type: core.Input }],
          skip: [{ type: core.Input }],
          detail_datatype: [{ type: core.Input }],
          detail_skip_array: [{ type: core.Input }],
          sourcedata: [{ type: core.Input }],
          modify_header_array: [{ type: core.Input }],
          deleteendpoint: [{ type: core.Input }],
          updateendpoint: [{ type: core.Input }],
          apiurl: [{ type: core.Input }],
          jwttoken: [{ type: core.Input }],
          statusarr: [{ type: core.Input }],
          emailarray: [{ type: core.Input }],
          editroute: [{ type: core.Input }],
          preview_artistxp: [{ type: core.Input }],
