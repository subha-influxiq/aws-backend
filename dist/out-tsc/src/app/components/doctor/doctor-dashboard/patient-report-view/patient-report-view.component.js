...
let PatientReportViewComponent = class PatientReportViewComponent {
    ...
    constructor(fb, activeRoute, router, httpService, datePipe, cookie, snakBar, dialog, commonFunction) {
        ...
        this.htmlText = { nav: 'Add Patient', header: "Physician Report" };
    ...
    setDefaultValue() {
        this.activeRoute.data.forEach((data) => {
            let reportDetails = data.data.res;
            ...
            let sDateArr = reportDetails[0].testDate.split("-");
            this.patientAddEditForm.controls['testDate'].patchValue(moment([sDateArr[2], sDateArr[1] - 1, sDateArr[0]]));
            let eDateArr = reportDetails[0].testCompletedDate.split("-");
            ...
            let dateOfBirth = reportDetails[0].birthDate;
...
PatientReportViewComponent = tslib_1.__decorate([
    Component({
...
export { PatientReportViewComponent };
//# sourceMappingURL=patient-report-view.component.js.map