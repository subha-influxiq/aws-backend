...
@Component({
  selector: 'app-create-reply-job-ticket',
  templateUrl: './create-reply-job-ticket.component.html',
  styleUrls: ['./create-reply-job-ticket.component.css']
})
export class CreateReplyJobTicketComponent implements OnInit {
