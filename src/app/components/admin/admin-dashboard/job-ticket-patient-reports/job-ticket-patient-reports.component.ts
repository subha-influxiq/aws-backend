...
export class JobTicketPatientReportsComponent implements OnInit {
  ...
  public report: any = [{ val: 11, 'name': 'Biller Admin Approved' }, { val: 12, 'name': 'Biller Admin Not Approved' }, { val: 13, 'name': "Biller Admin Hold" }]
