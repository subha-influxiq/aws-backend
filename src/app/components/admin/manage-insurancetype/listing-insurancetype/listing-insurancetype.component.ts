...
@Component({
  ...
  templateUrl: './listing-insurancetype.component.html',
  styleUrls: ['./listing-insurancetype.component.css']
})
export class ListingInsurancetypeComponent implements OnInit {
  ...
  public datacollection: any='getinsurancetypelistdata';
  public sortdata:any={
    "type":'desc',
 ...
 public limitcond:any={
  ...
  public search_settings: any =
    {
      ...
      textsearch: [{ label: "Search By insurancetypeName", field: 'name_search' }],
  ...
  ngOnInit() {
    this.datasource = '';
    let endpoint='getinsurancetypelistdata';
    let endpointc='getinsurancetypelistdata-count';
    let data:any={
        "condition":{
            "limit":10,
            "skip":0
