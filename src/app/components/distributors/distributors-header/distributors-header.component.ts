...
@Component({
  ...
  templateUrl: './distributors-header.component.html',
  styleUrls: ['./distributors-header.component.css']
})
export class DistributorsHeaderComponent implements OnInit {
  ...
  this.dialogRef.afterClosed().subscribe(result => {
    switch (result) {
      case "Yes":
        ...
        this.cookies.delete('jwtToken');
        this.cookies.deleteAll('/distributors');
