...
@Component({
  ...
  templateUrl: './doctor-group-header.component.html',
  styleUrls: ['./doctor-group-header.component.css']
})
export class DoctorGroupHeaderComponent implements OnInit {
  ...
  this.dialogRef.afterClosed().subscribe(result => {
    switch (result) {
      case "Yes":
        ...
        this.cookies.delete('jwtToken');
        this.cookies.deleteAll('/doctor_group');
