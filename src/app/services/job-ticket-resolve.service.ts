...
export class JobTicketResolveService implements Resolve<any> {
  ...
  constructor(private _apiService: JobTicketService, private router: Router, public cookiesService: CookieService) {
